...
function init_parallax(){
	...
	///////////////////////////////////
	   ...
	   preloadPictures(["img/"+bg[i], "img/"+middle[i], "img/"+front[i]], function(){
	...
	function init_landscape(){
	   ...
	   $('.slide-parallax'+zindex).children('.conteneurSlides').append("<div class='01-slideInterne"+zindex+"'><img src='img/"+bg[i]+"'/></div>");
	   $('.slide-parallax'+zindex).children('.conteneurSlides').append("<div class='02-slideInterne"+zindex+"'><img src='img/"+middle[i]+"'/></div>");
	   $('.slide-parallax'+zindex).children('.conteneurSlides').append("<div class='03-slideInterne"+zindex+"'><img src='img/"+front[i]+"'/></div>");
